...
abstract class $UserCopyWith<$Res> {
  ...
  @useResult
  $Res call({String id, String email, String? name, List<String> watchlist});
}
...
class _$UserImpl implements _User {
  const _$UserImpl(
      ...
      required this.email,
      required this.name,
      final List<String> watchlist = const []})
  ...
  @override
  String toString() {
    return 'User(id: $id, email: $email, name: $name, watchlist: $watchlist)';
  }
...
abstract class _User implements User {
  const factory _User(
      ...
      final List<String> watchlist}) = _$UserImpl;
